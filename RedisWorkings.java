...
public class RedisWorkings {
    ...
    Jedis jedis = new Jedis("localhost");
        Info 2016 total_state_generated_revenue_q1-q2 = new Info();
...
// add to the parent container (e.g. a JFrame):
        ...
        JLabel item1 = new JLabel("2016 total state generated revenue q1-q2 ");
        item1.setToolTipText("sough praise ember");
        jframe.add(item1);
...
// get the selected item:
       // String selectedBook = (String) stateList.getSelectedItem();
        ...
        System.out.println("loading: " + jedis.ping());
...
//        System.out.println((jedis.zrangeByScoreWithScores("names", 0, 1000).forEach(Tuple r:)}));
        ...
        System.out.println(jedis.zrange("2016 total state generated revenue q1-q2", 0, 100));
